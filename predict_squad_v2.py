...
def predict_squad(strategy):
    ...
    for i in range(len(all_results)):
        ...
        temp_file_name = checkpoint_path.split('/')[-1]
        prediction_file = temp_file_name+'_'+'predictions.json'
        nbest_file = temp_file_name+'_'+'nbest_predictions.json'
        null_file = temp_file_name+'_'+'null_odds.json'
